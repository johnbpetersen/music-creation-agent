...
This repo implements the Daydreams music creation agent: paid Ax-powered prompt refinement, ElevenLabs generation, x402 payments, and optional settlement. Use the guides below when evaluating the bounty submission.

| Guide | Summary |
| --- | --- |
| [setup.md](setup.md) | Local requirements, env files, running dev server, health checks. |
